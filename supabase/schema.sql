...
-- No anonymous table policies by design. Guests submit through a validated Edge Function.
-- Organizer reads should use an authenticated role with an explicit policy added at deployment.
